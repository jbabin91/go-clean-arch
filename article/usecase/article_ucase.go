...
import (
	...
	"github.com/jbabin91/go-clean-arch/article"
	_authorRepo "github.com/jbabin91/go-clean-arch/author"
)

type articleUsecase struct {
	articleRepos   article.Repository
	authorRepo     _authorRepo.Repository
...
func NewArticleUsecase(a article.Repository, ar _authorRepo.Repository, timeout time.Duration) article.ArticleUsecase {
